				...
				<div class="modal-dialog">
					<form class="modal-content" method="post">
						...
						<div class="modal-body">
							일정 제목 <input type="text" class="form-control" id="title"
								name="title">
							<div id="cate">
								카테고리 <br> <select name="cateNo" id="select"
							...
							내용 <input type="text" class="form-control" id="detail"
								name="content">
						</div>
						<div class="modal-footer">
							...
							<div id="center-bot2">
								<input class="btn btn-primary btn-user btn-block" type=""
									value="취소하기">
							</div>
						</div>
					</form>
